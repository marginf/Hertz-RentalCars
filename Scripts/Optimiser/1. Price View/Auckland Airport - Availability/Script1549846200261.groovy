...
WebUI.selectOptionByValue(findTestObject('Optimiser/1. Price View/Select_Region'),'1',false) //Auckland Airport
...
Assert.assertTrue(isFileDownloaded(downloadPath, 'Hertz_NZ_AucklandAirport_'+ todaysDate + '.zip'), 'Failed to download Expected document')
