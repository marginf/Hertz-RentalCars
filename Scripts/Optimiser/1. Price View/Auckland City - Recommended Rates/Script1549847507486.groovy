...
String PVDay = today.format("dd")
String PVMonth = today.format("MM")
String PVYear = today.format("yyyy")
use(TimeCategory){PVtodaysDate = (PVDay+'_'+PVMonth+'_'+PVYear)}
...
WebUI.selectOptionByIndex(findTestObject('Optimiser/1. Price View/Select_Market'),1)
...
WebUI.selectOptionByValue(findTestObject('Optimiser/1. Price View/Select_Region'),'2',false) //Auckland City
//'Select Category'
...
// Click Select cell in table
WebUI.focus(findTestObject('Optimiser/1. Price View/Data Table Row - Select Recommended Rates'))
WebUI.click(findTestObject('Optimiser/1. Price View/Data Table Row - Select Recommended Rates'))
...
//Modal Confirm Form displays
// Click on Download Rates button
WebUI.focus(findTestObject('Optimiser/1. Price View/Modal - Confirm Form/Button_Download Rates'))
WebUI.click(findTestObject('Optimiser/1. Price View/Modal - Confirm Form/Button_Download Rates'))
...
//Assert.assertTrue(isFileDownloaded(downloadPath, 'PriceView_'+ PVtodaysDate + '.XLSX'), 'Failed to download Expected document')
...
WebUI.click(findTestObject('Optimiser/1. Price View/Modal - Confirm Form/Button_Confirm Rates'))
WebUI.verifyTextPresent('Update successfully!',false)

//Click to Close Modal
WebUI.focus(findTestObject('Optimiser/1. Price View/Modal - Confirm Form/Button_Close Modal'))
WebUI.click(findTestObject('Optimiser/1. Price View/Modal - Confirm Form/Button_Close Modal'))
...
WebUI.selectOptionByIndex(findTestObject('Optimiser/1. Price View/Graph - Season Change'),2)
WebUI.delay(1)
...
WebUI.click(findTestObject('Optimiser/1. Price View/Graph - Min Price'))
// Mouseover Graph
WebUI.mouseOverOffset(findTestObject('Optimiser/1. Price View/Graph - MouseOver'), 1054, 107)
WebUI.scrollToElement(findTestObject('Optimiser/1. Price View/Button_Search'),1)

// Select Confirm Rates Button
...
WebUI.click(findTestObject('Optimiser/1. Price View/Modal - Invalid Rate/Table_PriceCell1 - Input'))
WebUI.clearText(findTestObject('Optimiser/1. Price View/Modal - Invalid Rate/Table_PriceCell1 - Input'))
WebUI.setText(findTestObject('Optimiser/1. Price View/Modal - Invalid Rate/Table_PriceCell1 - Input'),'255.00')
WebUI.verifyTextPresent('Update successfully!',false)
...
WebUI.click(findTestObject('Optimiser/1. Price View/Modal - Invalid Rate/Button_Close Modal'))
	...
	if (WebUI.verifyElementVisible(findTestObject('Optimiser/1. Price View/Modal - Invalid Rate/Table_PriceCell1 - Input'),false)) {
		throw new com.kms.katalon.core.exception.StepErrorException('Element not present')
		}
	}
	catch (StepErrorException e) {
		this.println(e)
