...
WebUI.selectOptionByIndex(findTestObject('Optimiser/1. Price View/Select_Market'),0)

//'Select Channel'
WebUI.click(findTestObject('Optimiser/1. Price View/Select_Channel'))
WebUI.selectOptionByLabel(findTestObject('Optimiser/1. Price View/Select_Channel'),'Direct',false)

// Select Region
WebUI.click(findTestObject('Optimiser/1. Price View/Select_Region'))
WebUI.selectOptionByValue(findTestObject('Optimiser/1. Price View/Select_Region'),'1',false) //Adelaide Airport
...
WebUI.check(findTestObject('Optimiser/1. Price View/Select_Car_5'))
TempCar5 = WebUI.getText(findTestObject('Optimiser/1. Price View/Select_Car_5 - Text'))
WebUI.click(findTestObject('Optimiser/1. Price View/Select_Car'))
...
WebUI.check(findTestObject('Optimiser/1. Price View/select_Season_week4'))

//'Extract Season Week 4'
TSeasonWeek4 = WebUI.getText(findTestObject('Optimiser/1. Price View/select_Season_week4_Text'))
...
WebUI.selectOptionByLabel(findTestObject('Optimiser/1. Price View/Select_View Type'),'Recommended Rates',false)
...
WebUI.click(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Select_Row1_Cell1'))
//WebUiCommonHelper.findWebElement(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Select_Row1_Cell1'), 2).clear()
WebUI.sendKeys(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Input_Row1_Cell1'), Keys.chord(Keys.CONTROL, 'a'))
WebUI.sendKeys(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Input_Row1_Cell1'), Keys.chord(Keys.DELETE))
WebUI.click(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Select_Row1_Cell1'))
WebUI.setText(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Input_Row1_Cell1'),'45.00',)

WebUI.click(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Select_Row2_Cell1'))
//WebUiCommonHelper.findWebElement(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Select_Row2_Cell1'), 2).clear()
WebUI.sendKeys(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Input_Row2_Cell1'), Keys.chord(Keys.CONTROL, 'a'))
WebUI.sendKeys(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Input_Row2_Cell1'), Keys.chord(Keys.DELETE))
WebUI.click(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Select_Row2_Cell1'))
WebUI.setText(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Input_Row2_Cell1'),'46.00',)

WebUI.click(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Select_Row3_Cell1'))
//WebUiCommonHelper.findWebElement(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Select_Row3_Cell1'), 2).clear()
WebUI.sendKeys(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Input_Row3_Cell1'), Keys.chord(Keys.CONTROL, 'a'))
WebUI.sendKeys(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Input_Row3_Cell1'), Keys.chord(Keys.DELETE))
WebUI.click(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Select_Row3_Cell1'))
WebUI.setText(findTestObject('Optimiser/1. Price View/Modal - Edit Rates/Input_Row3_Cell1'),'47.00',)
...
Assert.assertTrue(isFileDownloaded(downloadPath, 'Hertz_AU_AdelaideAirport_'+ todaysDate + '.zip'), 'Failed to download Expected document')
...
WebUI.selectOptionByValue(findTestObject('Optimiser/1. Price View/Graph - View Change'),'Categories',false)
WebUI.click(findTestObject('Optimiser/1. Price View/Graph - View Change'))
WebUI.delay(1)
...
WebUI.selectOptionByValue(findTestObject('Optimiser/1. Price View/Graph - Category Change'),'H_Compact (Toyota Corolla)',false)
WebUI.click(findTestObject('Optimiser/1. Price View/Graph - Category Change'))
WebUI.delay(1)
WebUI.focus(findTestObject('Optimiser/1. Price View/Graph - View Change'))
WebUI.click(findTestObject('Optimiser/1. Price View/Graph - View Change'))
WebUI.selectOptionByValue(findTestObject('Optimiser/1. Price View/Graph - View Change'),'Seasons',false)
WebUI.click(findTestObject('Optimiser/1. Price View/Graph - View Change'))
WebUI.delay(1)
...
WebUI.click(findTestObject('Optimiser/1. Price View/Graph - Current Utilisation'))
WebUI.click(findTestObject('Optimiser/1. Price View/Graph - Min Price'))
WebUI.scrollToElement(findTestObject('Optimiser/1. Price View/Button_Search'),1)
...
WebUI.verifyTextPresent('Update successfully!',false)
WebUI.focus(findTestObject('Optimiser/1. Price View/Modal - Multiple Durations/Button_Close Modal'))
WebUI.click(findTestObject('Optimiser/1. Price View/Modal - Multiple Durations/Button_Close Modal'))
