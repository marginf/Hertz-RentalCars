...
WebUI.selectOptionByValue(findTestObject('Optimiser/1. Price View/Select_Region'),'13',false) //Melbourne City
WebUI.click(findTestObject('Optimiser/1. Price View/Select_Region'))
//'Select Category'
...
WebUI.selectOptionByLabel(findTestObject('Optimiser/1. Price View/Select_View Type'),'Availability',false)
//Other options: Recommended Rates, Current Rates,Forecast Utilisation,Current Utilisation,Recommended V Current,Availability
...
//Assert.assertTrue(isFileDownloaded(downloadPath, 'Hertz_AU_MelbourneDowntown-FlindersStreet_'+ todaysDate + '.zip'), 'Failed to download Expected document')
...
WebUI.selectOptionByIndex(findTestObject('Optimiser/1. Price View/Graph - Category Change'),3)
WebUI.click(findTestObject('Optimiser/1. Price View/Graph - View Change'))
