...
WebUI.selectOptionByValue(findTestObject('Optimiser/1. Price View/Select_Region'),'12',false) //Melbourne Airport
...
Assert.assertTrue(isFileDownloaded(downloadPath, 'Hertz_AU_MelbourneAirport,Australia(Tullamarine)_'+ todaysDate + '.zip'), 'Failed to download Expected document')
...
WebUI.selectOptionByValue(findTestObject('Optimiser/1. Price View/Graph - Category Change'),'Mystery Car Prestige ((X9) Mystery Car Prestige)',false)
WebUI.click(findTestObject('Optimiser/1. Price View/Graph - Category Change'))
WebUI.delay(1)
WebUI.focus(findTestObject('Optimiser/1. Price View/Graph - View Change'))
WebUI.click(findTestObject('Optimiser/1. Price View/Graph - View Change'))
