...
WebUI.selectOptionByValue(findTestObject('Optimiser/1. Price View/Select_Region'),'7',false) //Wellington Airport
...
WebUI.selectOptionByLabel(findTestObject('Optimiser/1. Price View/Select_View Type'),'Current Rates',false)
...
Assert.assertTrue(isFileDownloaded(downloadPath, 'Hertz_NZ_WellingtonAirport_'+ todaysDate + '.zip'), 'Failed to download Expected document')
