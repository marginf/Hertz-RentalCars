...
WebUI.selectOptionByValue(findTestObject('Optimiser/1. Price View/Select_Region'),'19',false) //Sydney City
WebUI.click(findTestObject('Optimiser/1. Price View/Select_Region'))
//'Select Category'
...
WebUI.selectOptionByLabel(findTestObject('Optimiser/1. Price View/Select_View Type'),'Recommended V Current',false)
...
//Assert.assertTrue(isFileDownloaded(downloadPath, 'Hertz_AU_SydneyDowntown_'+ todaysDate + '.zip'), 'Failed to download Expected document')
