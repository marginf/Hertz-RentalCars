...
WebUI.verifyTextPresent('Only Recomend Rates can be accepted!',false)

// Click on Confirm Rates button
WebUI.focus(findTestObject('Optimiser/1. Price View/Modal - Confirm Form/Button_Confirm Rates'))
...
WebUI.verifyTextPresent('[3] Records need to be Updated!',false)
WebUI.verifyTextPresent('Update [3] Records Successfully!', false)
...
WebUI.setText(findTestObject('Optimiser/1. Price View/Modal - Invalid Rate/Table_PriceCell1 - Input'),'35.00')
WebUI.clearText(findTestObject('Optimiser/1. Price View/Modal - Invalid Rate/Table_PriceCell2 - Input'))
WebUI.setText(findTestObject('Optimiser/1. Price View/Modal - Invalid Rate/Table_PriceCell2 - Input'),'36.00')
WebUI.clearText(findTestObject('Optimiser/1. Price View/Modal - Invalid Rate/Table_PriceCell3 - Input'))
WebUI.setText(findTestObject('Optimiser/1. Price View/Modal - Invalid Rate/Table_PriceCell3 - Input'),'37.00')
