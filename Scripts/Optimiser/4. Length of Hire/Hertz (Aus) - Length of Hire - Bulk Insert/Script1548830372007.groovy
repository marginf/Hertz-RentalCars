...
WebUI.click(findTestObject('Optimiser/4. Length of Hire/Bulk Insert Modal/Category-AusDropDown1'))
WebUI.click(findTestObject('Optimiser/4. Length of Hire/Bulk Insert Modal/Category-AusDropDown2'))
WebUI.click(findTestObject('Optimiser/4. Length of Hire/Bulk Insert Modal/Category-Option')) 
